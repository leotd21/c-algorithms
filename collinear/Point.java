...
public class Point implements Comparable<Point> {
    ...
    private class BySlope implements Comparator<Point> {
        public int compare(Point v, Point w) {
            double firstSlope = slopeTo(v);
            double secondSlope = slopeTo(w);
            // if (firstSlope == secondSlope) return v.compareTo(w);
    ...
    public static void main(String[] args) {
        ...
        Point w = new Point(2, 4);
        StdOut.println(v.slopeTo(w));
        Point v2 = new Point(1, 2);
        Point w2 = new Point(1, 4);
        StdOut.println(v2.slopeTo(w2));
        Point v3 = new Point(1, 2);
        Point w3 = new Point(1, 2);
        StdOut.println(v3.slopeTo(w3));
    }
}
